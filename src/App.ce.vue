    ...
    <main v-if="!$root.renderUserGuide">
        ...
        <div
            ...
            <loading-indicator
                v-if="!payload"
                aria-hidden="true"
                class="mb-8 h-8 w-8"></loading-indicator>
            <template v-else>
                <Meta> </Meta>
                <section
                    class="my-8 flex flex-col gap-8 lg:grid lg:grid-cols-4">
    ...
    export default {
        ...
        computed: {
            ...
            fullTextTotal() {
                ...
                return md.render(
                    this.strings.__(
                        this.balance > 0 ? "total_increase" : "total_decrease",
                        {
                            absbalance: this.strings.formatNumber(
                                this.strings.roundCurrency(
