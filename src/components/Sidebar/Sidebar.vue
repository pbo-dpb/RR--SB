<template>
    <aside class="flex flex-col-reverse gap-8 lg:flex-col">
        <div class="md:block">
        ...
        <div v-if="$root.balance">
            <div ref="printable">
                <ul
                    class="mb-2 flex flex-col gap-2 border-b border-gray-100 pb-2">
                    <section-recap
        ...
        methods: {
            triggerPrint() {
                ...
                logoTag.setAttribute(
                    "src",
                    `https://www.pbo-dpb.ca/cms/svg/logo.full.${this.$root.language}.svg`,
                );
                ...
                header.insertAdjacentHTML(
                    ...
                    "<small class='italic text-gray-800'>" +
                        [
                            this.$root.strings.impact_in_millions,
                ...
                container.insertAdjacentHTML(
                    "beforeend",
                    `<div class='mt-8 text-center font-semibold'>${this.$root.fullTextTotal}</div>`,
                );

                const winUrl = URL.createObjectURL(
                    new Blob([`<!DOCTYPE html>`, prHtml.outerHTML], {
                        type: "text/html",
                    }),
                );
