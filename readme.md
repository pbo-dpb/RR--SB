...
- Estimates shown under the Corporate Income Taxes (CIT) section were developed using the PBO’s Corporate Tax Model. Simulations were performed on 2024 tax data using 2026 tax parameters and the results were scaled up to 2026 based on our September 2025 Economic and Fiscal Outlook projection of CIT revenue.[^5] For the General Corporate Rate and the Small Business Rate, SPSD/M v. 34.0 was used to adjust the dividend gross-up rate and the federal dividend tax credit rate for personal income taxes (PIT).
